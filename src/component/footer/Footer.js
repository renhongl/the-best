        ...
        return (
            <footer className='footer' style={style}>
                <div className='left' style={style}>
                    <Tooltip title={lang[language]['APPLICATION']}><span className='icon' onClick={toggleStore}><Icon type="home"  style={color}/></span></Tooltip>
                    {minDialogs}
                </div>
                <div className='right' style={style}>
                    <Tooltip title={lang[language]['SETTING']}><span className='icon' onClick={toggleSetting}><Icon type="setting"  style={color}/></span></Tooltip>
